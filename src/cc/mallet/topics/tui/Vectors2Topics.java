...
public class Vectors2Topics {
	...
	static CommandOption.Integer bubbleOption = new CommandOption.Integer
	(Vectors2Topics.class, "bubble", "INTEGER", true, 0,
	"bubble sort options: 0:bubble0, 1:bubble1, 2:bubbl2, 3:bubble3, 4:bubble, 5:treemap, others:fast.", null);	
